...
Timer timer;
static int interval, delay, period, bombDelay, tankCounter, maxBombCount, keycounter;
final int start = 0, intro = 1, game = 2, pause = 3, gameOver = 4, reset = 5;
volatile int state, tank1posX, tank2posX, tank1posY, tank2posY, planeCount;
...
void draw() {
  ...
  case gameOver:
    ...
    text("r key to reset!!", 150, height/2+325);  
    break;
